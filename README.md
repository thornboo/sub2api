...
```bash
curl -sSL https://raw.githubusercontent.com/thornboo/sub2api/dev-zz/deploy/install.sh | sudo bash
```
...
# Uninstall
curl -sSL https://raw.githubusercontent.com/thornboo/sub2api/dev-zz/deploy/install.sh | sudo bash -s -- uninstall -y
```
...
git clone https://github.com/thornboo/sub2api.git
cd sub2api/deploy
...
<a href="https://star-history.dera.page/#thornboo/sub2api&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://star-history.dera.page/svg?repos=thornboo/sub2api&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://star-history.dera.page/svg?repos=thornboo/sub2api&type=Date" />
   <img alt="Star History Chart" src="https://star-history.dera.page/svg?repos=thornboo/sub2api&type=Date" />
 </picture>
</a>
