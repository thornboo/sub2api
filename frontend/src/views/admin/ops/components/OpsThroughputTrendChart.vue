...
<template>
  <div class="card flex h-full min-w-0 flex-col p-6">
    ...
    >
      <h3 class="flex min-w-0 items-center gap-2 text-sm font-bold text-stone-950 dark:text-white">
      ...
      >
        ...
        <template v-if="!props.fullscreen">
          <button
            type="button"
            class="inline-flex shrink-0 items-center rounded-lg border border-stone-200 bg-white/80 px-2 py-1 text-[11px] font-semibold text-stone-600 hover:bg-stone-50 disabled:opacity-50 dark:border-white/10 dark:bg-black/30 dark:text-stone-300 dark:hover:bg-white/[0.06]"
