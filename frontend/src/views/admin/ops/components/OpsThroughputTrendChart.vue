  ...
  <div class="card flex h-full flex-col p-6">
    <div class="mb-4 flex shrink-0 items-center justify-between">
      ...
      <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
        ...
        <template v-if="!props.fullscreen">
          <button
            type="button"
            class="ml-2 inline-flex items-center rounded-lg border border-stone-200 bg-white/80 px-2 py-1 text-[11px] font-semibold text-stone-600 hover:bg-stone-50 disabled:opacity-50 dark:border-white/10 dark:bg-black/30 dark:text-stone-300 dark:hover:bg-white/[0.06]"
          ...
          <button
            type="button"
            class="inline-flex items-center rounded-lg border border-stone-200 bg-white/80 px-2 py-1 text-[11px] font-semibold text-stone-600 hover:bg-stone-50 disabled:opacity-50 dark:border-white/10 dark:bg-black/30 dark:text-stone-300 dark:hover:bg-white/[0.06]"
            :disabled="state !== 'ready'"
    ...
    <div v-if="(props.topGroups?.length ?? 0) > 0" class="mb-3 flex flex-wrap gap-2">
      <button
        ...
        :key="g.group_id"
        type="button"
        class="inline-flex items-center gap-2 rounded-full border border-stone-200 bg-white/80 px-3 py-1 text-[11px] font-semibold text-stone-700 hover:bg-stone-50 dark:border-white/10 dark:bg-black/30 dark:text-stone-200 dark:hover:bg-white/[0.06]"
