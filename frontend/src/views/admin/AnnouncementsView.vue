      ...
      <template #table>
        ...
        >
          <template #cell-title="{ value, row }">
            <div class="min-w-0">
              <div class="flex items-center gap-2">
                <span class="truncate font-medium text-stone-950 dark:text-white">{{ value }}</span>
              </div>
              <div class="mt-1 flex items-center gap-2 text-xs text-stone-500 dark:text-stone-400">
                <span>#{{ row.id }}</span>
          ...
          <template #cell-created_at="{ value }">
            <span class="text-sm text-stone-500 dark:text-stone-400">{{ formatDateTime(value) }}</span>
          </template>
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center space-x-1">
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-stone-500 transition-colors hover:bg-emerald-50 hover:text-emerald-700 dark:hover:bg-emerald-500/15 dark:hover:text-emerald-300"
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-stone-500 transition-colors hover:bg-stone-100 hover:text-stone-700 dark:hover:bg-white/[0.08] dark:hover:text-stone-300"
                :title="t('common.edit')"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-stone-500 transition-colors hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-500/15 dark:hover:text-red-300"
