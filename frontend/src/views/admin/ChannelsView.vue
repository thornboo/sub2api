...
function createPricingEntry(models: string[] = [], defaults?: ModelDefaultPricing): PricingFormEntry {
  return {
    ...
    cache_write_1h_price: defaults?.found ? perTokenToMTok(defaults.cache_write_1h_price ?? null) : null,
    cache_read_price: defaults?.found ? perTokenToMTok(defaults.cache_read_price ?? null) : null,
    fast_multiplier: null,
    flex_multiplier: null,
    max_reasoning_effort_multiplier: defaults?.found ? defaults.max_reasoning_effort_multiplier ?? null : null,
