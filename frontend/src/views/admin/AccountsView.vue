<template>
  <AppLayout>
            ...
            <template #after>
              ...
              <div v-if="activeAccountView !== 'cost'" class="relative" ref="autoRefreshDropdownRef">
                ...
                <div
                  ...
                  class="popover-surface absolute right-0 z-50 mt-2 w-56 origin-top-right p-1"
                >
                  <div>
                    <button
                    ...
                    >
                      ...
                      <Icon v-if="autoRefreshEnabled" name="check" size="sm" class="text-emerald-500" />
                    </button>
                    ...
                    >
                      ...
                      <Icon v-if="autoRefreshIntervalSeconds === sec" name="check" size="sm" class="text-emerald-500" />
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div v-if="activeAccountView !== 'cost'" class="relative" ref="accountToolsDropdownRef">
                ...
                <Teleport to="body">
                  <div
                    ...
                    class="popover-surface fixed z-[9999] origin-top-right overflow-hidden"
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-last_used_at="{ value }">
            <span class="text-sm text-gray-500 dark:text-stone-500">{{ formatRelativeTime(value) }}</span>
          </template>
    ...
    <AccountActionMenu :show="menu.show" :account="menu.acc" :anchor-rect="menu.anchorRect" @close="menu.show = false" @test="handleTest" @stats="handleViewStats" @model-protocols="handleModelProtocols" @schedule="handleSchedule" @duplicate="handleDuplicateAccount" @reauth="handleReAuth" @refresh-token="handleRefresh" @recover-state="handleRecoverState" @reset-quota="handleResetQuota" @set-privacy="handleSetPrivacy" @create-spark-shadow="handleCreateSparkShadow" />
...
function getAntigravityTierClass(row: any): string {
  const tier = getAntigravityTierFromRow(row)
  switch (tier) {
    case 'free-tier': return 'bg-gray-100 text-gray-600 dark:bg-white/[0.08] dark:text-gray-300'
    case 'g1-pro-tier': return 'bg-emerald-100 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-300'
