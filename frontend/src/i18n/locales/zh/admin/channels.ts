export default {
    ...
    channels: {
      ...
      timePricingValidation: {
        tokenOnly: '分时定价仅支持 Token 计费模式',
        invalidTimezone: '时区「{timezone}」不是有效的 IANA timezone',
        defaultLabelRequired: '请填写“其余时段”的类型名称',
        defaultLabelTooLong: '“其余时段”的类型名称最多 {max} 个字符',
        defaultMultiplierRange: '其余时段倍率「{value}」必须在 0 到 100 之间',
        tooManyRules: '分时规则最多 {max} 条',
        ruleLabelRequired: '分时规则 #{index}：请填写类型名称',
        ruleLabelTooLong: '分时规则 #{index}：类型名称最多 {max} 个字符',
        invalidStart: '分时规则 #{index}：开始时间「{value}」必须是 HH:MM',
        invalidEnd: '分时规则 #{index}：结束时间「{value}」必须是 HH:MM',
        equalRange: '分时规则 #{index}：开始和结束不能相同（{range}）',
        multiplierRange: '分时规则 #{index}：倍率「{value}」必须在 0 到 100 之间',
        overlap: '分时规则重叠：{first}（{firstRange}）与 {second}（{secondRange}）冲突',
        ruleIndex: '规则 #{index}'
      },
      ...
      form: {
        ...
        timePricing: '分时定价',
        timePricingEnabled: '启用分时定价',
        timePricingTimezone: '时区',
        timePricingTimezonePlaceholder: '选择时区',
        timePricingTimezoneSearch: '搜索 IANA 时区',
        timePricingTimezoneUse: '使用时区',
        timePricingOtherTimes: '其余时段',
        timePricingDefaultMultiplier: '其余时段倍率',
        timePricingTypeName: '类型名称',
        timePricingDefaultLabelPlaceholder: '例如：平时',
        timePricingRuleLabelPlaceholder: '例如：高峰',
        timePricingStart: '开始',
        timePricingEnd: '结束',
        timePricingMultiplier: '倍率',
        timePricingAddRule: '添加时段',
        timePricingRemoveRule: '删除时段',
        timePricingMoveRuleUp: '上移时段',
        timePricingMoveRuleDown: '下移时段',
        timePricingCrossMidnight: '跨午夜',
        timePricingFreeWarning: '0x 表示该窗口免费',
        timePricingDefaultFreeWarning: '0x 表示所有未命中显式规则的时间免费',
        timePricingHint: '类型名称将原样展示给用户，不会根据倍率自动推断；未命中显式规则时使用“其余时段”配置。允许跨午夜，规则之间不能重叠。',
        ...
        intervalBoundsHint: '区间按 (最小, 最大] 判断：最小不含、最大含。连续分档时，下一档最小应填上一档最大，例如第一档最大 272000，第二档最小填 272000；272001 会进入第二档。',
        intervalGapWarning: '区间 {previousMax} 到 {currentMin} 之间有空档：Token {missingStart} 至 {missingEnd} 不会命中这些区间，将回退基础价格。',
        ...
        sortByMapping: '按映射整理',
        addPricing: '补定价',
        mappingModelsCount: '映射模型 {count}',
        pricingCoveredCount: '已覆盖 {count}',
        pricingMissingCount: '缺失 {count}',
        pricingExtraCount: '额外定价 {count}',
        showMissingModels: '查看缺失',
        hideMissingModels: '收起缺失',
        quickPricing: '快速定价',
        quickPricingHint: '确认模型映射无误后，根据当前映射一次性补充缺失的定价条目',
        quickPricingRunning: '定价中...',
        quickPricingSuccess: '已为 {count} 个模型生成定价条目',
        upstreamPricingCoverageUnknown: '当前按最终上游模型计费，无法仅根据渠道映射可靠判断定价覆盖。',
        missingPricingCoverage: '{platform} 仍有未加入定价列表的映射模型：{models}',
    ...
    channelMonitor: {
      ...
      form: {
        ...
        checkMode: '检测模式',
        checkModeProbe: '探活',
        checkModeProbeHint: '发送轻量请求验证端点可用性。',
        checkModeQuota: '配额',
        checkModeQuotaHint: '在支持的平台上从绑定账号读取配额或用量证据。',
        checkModeQuotaProbe: '探活 + 配额',
        checkModeQuotaProbeHint: '同一次检测读取配额证据并执行可用性探活。',
        endpoint: '上游地址',
        endpointPlaceholder: 'https://api.example.com',
        linkedAccount: '绑定账号',
        linkedAccountPlaceholder: '选择绑定账号',
        linkedAccountHint: '配额检测仅使用该账号读取可观察的配额证据。',
        linkedAccountMissing: '绑定账号已不可用，请选择其他账号后再保存。',
        linkedAccountEmpty: '该平台暂无符合条件的账号',
        openAIQuotaProbeHint: 'OpenAI 配额检测需要绑定可读取配额证据的 OAuth 账号。',
