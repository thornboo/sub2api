export default {
    accounts: {
      ...
      openai: {
        ...
        responsesMode: '旧版 Chat / Responses 路由偏好',
        responsesModeDesc:
          '仅在“模型多 API 端点路由”关闭时用于 OpenAI API Key 文本转发。开启严格路由后，以“上游模型协议能力”的逐模型配置为准，此处不会覆盖。',
        ...
        endpointCapabilitiesDesc:
          '账号级调度开关。文本生成开关不代表具体模型支持 Chat 或 Responses；严格多协议路由以“上游模型协议能力”为准。Embeddings 独立控制 /v1/embeddings。',
        ...
        responsesStatusAutoSupported: '旧路由探测：Responses',
        responsesStatusAutoUnsupported: '旧路由探测：Chat Completions',
        responsesStatusAutoUnknown: '旧路由探测：未探测',
        responsesStatusForcedResponses: '旧路由强制 Responses',
        responsesStatusForcedChatCompletions: '旧路由强制 Chat Completions',
        planType: '订阅档位（手动覆盖）',
      ...
      concreteTestModel: '具体模型 ID',
      concreteTestModelPlaceholder: '输入要测试的完整模型 ID',
      concreteTestModelHint: '这是通配符规则，请填写具体的模型 ID。',
      concreteTestModelRequired: '请填写具体模型 ID，不能包含 *。',
      resolvedTestModel: '实际发送到上游：{model}',
      resolveTestModelFailed: '无法匹配有效模型，请检查模型 ID 和账号配置。',
      testModel: '测试模型',
      testPrompt: '提示词："hi"',
      ...
      modelProtocol: {
        ...
        globalRoutingUnknownHint: '账号协议能力仍可查看和保存；请刷新或前往系统设置确认全局开关后，再判断这些能力是否已参与实际路由。',
        manageGlobalRouting: '管理全局开关',
        sync: '从上游同步',
        syncing: '同步中...',
        syncSuccess: '已同步并回填协议选项，请保存管理员策略',
        syncNoChanges: '已同步，本次没有明确的协议结果，原有选择已保留',
        syncWarnings: '同步警告',
        saveSuccess: '协议能力覆盖已保存',
        addExactModel: '手动添加精确上游模型',
        modelPlaceholder: '例如 MiniMax-M3；用于上游无法声明能力时手动覆盖',
        addModel: '添加模型',
        invalidModel: '模型名必须是 1–255 个字符，且不能包含 * 或控制字符',
        duplicateModel: '该模型已经在能力列表中',
        supplierHintTitle: '协议能力按账号配置',
        supplierHint: '供应商只负责成本与余额归属。请到账号列表中，为对应的 OpenAI API Key 账号配置模型协议能力。',
        goToAccountList: '前往账号列表',
        upstreamModel: '上游模型',
        defaultCapability: '账号默认能力',
        exactModel: '精确模型能力',
        publicModelImpacts: '影响的渠道模型',
        moreImpacts: '另有 {count} 条渠道路由',
        orphanCapability: '当前没有渠道模型通过该账号路由到此上游模型',
        anthropicMessages: 'Anthropic Messages',
        openaiChat: 'OpenAI Chat',
        openaiResponses: 'OpenAI Responses',
        effectiveState: '当前生效',
        afterSaveState: '保存后生效',
        observedEvidence: '上游观察',
        overridePolicy: '管理员策略',
        auto: '自动',
        forceSupported: '强制支持',
        forceUnsupported: '强制不支持',
        supportedShort: '支持',
        unsupportedShort: '不支持',
        overrideLabel: '{model} 的 {protocol} 管理员覆盖',
        noEvidence: '暂无能力证据',
        saveHint: '同步会用本次明确结果覆盖选项，未知项保留原选择；管理员策略需点击保存。',
        states: {
          supported: '支持',
          unsupported: '不支持',
          unknown: '未知'
        ...
        sources: {
          upstreamModelList: '上游模型列表声明',
          upstreamDidNotDeclare: '上游未声明协议能力',
          upstreamEmptyDeclaration: '上游返回了空协议能力列表',
          upstreamUnknownDeclaration: '上游包含未知协议声明',
          legacyMigration: '存量探测结果迁移',
          adminOverride: '管理员覆盖',
          intrinsic: '账号类型固有能力'
        }
      },
