export default {
  ...
  keyUsage: {
    ...
    noUnreadAnnouncements: '暂无未读公告',
    refreshAnnouncements: '刷新',
    loadingAnnouncements: '正在加载公告...',
    noAnnouncements: '当前 Key 暂无公告',
    announcementsFailed: '公告加载失败',
    announcementReadFailed: '公告标记已读失败',
    markingAnnouncementRead: '标记中...',
    unlimited: '无限制',
    never: '永不过期',
    status: {
      active: '启用',
