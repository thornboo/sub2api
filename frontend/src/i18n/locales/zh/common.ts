export default {
  ...
  feedback: {
    ...
    entry: '工单',
    myTickets: '我的工单',
    myTicketsDescription: '提交使用问题，查看回复和处理进度。',
    newTicket: '提交工单',
    titleLabel: '标题',
    titlePlaceholder: '例如：充值成功后余额未到账',
    titleHint: '用一句话概括你遇到的问题。',
    titleRequired: '请输入工单标题。',
    titleTooLong: '标题不能超过 {max} 个字符。',
    filterLabel: '工单状态',
    contentLabel: '问题描述',
    placeholder: '请说明具体问题、发生时间和相关现象，或填写你的建议。',
    ...
    loadingTickets: '正在加载工单记录...',
    loadingMessages: '正在加载回复...',
    emptyTickets: '暂无工单记录',
    selectTicket: '选择一条工单，查看问题详情和回复',
    noReplies: '暂无回复',
    ...
    closedReadOnly: '该工单已关闭，不能继续回复。',
    closedStale: '该工单已被关闭，已刷新最新状态。',
