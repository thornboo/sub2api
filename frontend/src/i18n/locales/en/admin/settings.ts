export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        nativeModelProtocolRoutingHint: 'When enabled, confirmed per-model protocol capabilities drive both API endpoint visibility in the model marketplace and actual request routing. Disabling keeps the capability data and preserves the existing compatibility path.',
