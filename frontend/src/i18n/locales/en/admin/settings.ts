export default {
    settings: {
      ...
      features: {
        ...
        availableChannels: {
          title: 'Model Catalog',
          description: 'Show signed-in users the models, pricing, and service performance for groups they can access.',
          configureLink: 'Configure model pricing in Channel Management > Channel Pricing',
          enabled: 'Enable Model Catalog',
          enabledHint: 'When off, the user navigation entry is hidden and the model catalog is no longer displayed.',
        },
        siteBillingMode: {
        ...
        modelPlaza: {
          ...
          enabledHint: 'When enabled, an entry appears on the Home page and the page is reachable at /model-plaza.',
          ...
          priceDescriptionHint: 'Rendered at the top of the public model catalog. Use it for billing rules, exchange rates, promotions, etc.',
        },
        pluginManagement: {
      ...
      gatewayForwarding: {
        ...
        nativeModelProtocolRouting: 'Multi-endpoint Model Routing',
        nativeModelProtocolRoutingHint: 'When enabled, confirmed per-model protocol capabilities drive both API endpoint visibility in the model catalog and actual request routing. Disabling keeps the capability data and preserves the existing compatibility path.',
        routingEnabled: 'Enabled',
        routingDisabled: 'Disabled',
        sourceSettings: 'Source: admin settings',
        sourceConfig: 'Source: config default',
        sourceSettingsInvalid: 'Source: invalid admin setting',
        sourceConfigInvalid: 'Source: invalid config fallback',
        sourceErrorFallback: 'Source: safe error fallback',
        sourceEnforceBlocked: 'Source: enforcement not ready; safely downgraded',
        enableRoutingConfirmTitle: 'Enable multi-endpoint model routing?',
        enableRoutingConfirmMessage: 'Confirmed API endpoints will become visible in the customer model catalog and may be preferred for native upstream delivery on new requests. Verify account protocol capabilities before enabling. In-flight requests are unaffected.',
        ...
        enterpriseMemberAdmissionEnforceHint: 'Only groups with an exact published model and stable delivery candidate can execute the request.',
        enterpriseMemberAdmissionSourceWarning: 'The current source is invalid or degraded; verify the saved setting or deployment config before enabling enforcement.',
        enterpriseMemberAdmissionEnforceConfirmTitle: 'Enforce published-model admission?',
        enterpriseMemberAdmissionEnforceConfirmMessage: 'Enterprise member requests will stop falling back to the first authorized group. A model will run only when the selected group has exact publication and stable delivery eligibility.',
        enterpriseMemberAdmissionEnforceConfirmAction: 'Enforce admission',
        enterpriseMemberAdmissionEnforceBlocked: 'Phase 3 prerequisites are incomplete, so the server has disabled global enforcement. Use shadow evaluation or legacy rollback mode for now.',
        enterpriseMemberAdmissionReadiness: 'Readiness',
        enterpriseMemberAdmissionReady: 'Ready for enforcement',
        enterpriseMemberAdmissionNotReady: 'Not ready',
        enterpriseMemberAdmissionRollout: 'Rollout',
        enterpriseMemberAdmissionRolloutValue: '{source} · {percentage}',
        enterpriseMemberAdmissionRolloutDetail: '{enterprises} enterprise user(s), {members} member(s), hash bucket {bucket}, {matched}',
        enterpriseMemberAdmissionAutoStop: 'Auto-stop',
        enterpriseMemberAdmissionAutoStopped: 'Stopped by guardrail',
        enterpriseMemberAdmissionAutoStopArmed: 'Guardrail armed',
        enterpriseMemberAdmissionAutoStopOff: 'Not configured',
        enterpriseMemberAdmissionLegacyDeprecation: 'Legacy retirement',
        enterpriseMemberAdmissionLegacyUsage: 'Effective in this process: {count}',
        enterpriseMemberAdmissionLegacyRetirementValue: '{status} · {target}',
        enterpriseMemberAdmissionRetirementNotScheduled: 'not scheduled',
        enterpriseMemberAdmissionLegacyRetirementTarget: 'Retirement target',
        enterpriseMemberAdmissionLegacyRetirementPlaceholder: '2026-09-30 or v1.8.0',
        enterpriseMemberAdmissionLegacyRetirementHint: 'Use an explicit ISO date or version. When empty, Phase 5 remains not_scheduled.',
        enterpriseMemberAdmissionRiskReductionOnly: 'legacy_order_only is deprecated and may only be used as an emergency rollback to reduce production risk, not to expand routing behavior.',
        enterpriseMemberAdmissionEnterpriseIds: 'Enterprise user IDs',
        enterpriseMemberAdmissionMemberIds: 'Member IDs',
        enterpriseMemberAdmissionIdsPlaceholder: 'e.g. 12, 13, 21',
        enterpriseMemberAdmissionPercentage: 'Rollout percentage',
        enterpriseMemberAdmissionSalt: 'Stable hash salt',
        enterpriseMemberAdmissionManualStop: 'Manual emergency stop rollout',
        enterpriseMemberAdmissionAliasReview: 'Alias Review',
        enterpriseMemberAdmissionAliasReviewHint: 'Review exact alias candidates observed in the last 7 and 30 days before enforcing publication.',
        enterpriseMemberAdmissionAliasEmpty: 'No alias candidates require review.',
        enterpriseMemberAdmissionAliasLoadFailed: 'Failed to load alias review candidates',
        enterpriseMemberAdmissionAliasReviewed: 'Alias review saved',
        enterpriseMemberAdmissionAliasReviewFailed: 'Failed to save alias review',
        aliasModel: 'Alias',
        aliasTarget: 'Target',
        aliasUsage7d: '7d',
        aliasUsage30d: '30d',
      ...
      openaiFastPolicy: {
        ...
        userIdsValidationError: 'User IDs must be unique positive integers within each rule.',
        errorMessage: 'Error message',
        errorMessagePlaceholder: 'Custom error message when blocked',
