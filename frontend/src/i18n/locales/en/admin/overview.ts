export default {
    ...
    users: {
      ...
      form: {
		...
		accountTypes: { individual: 'Individual', enterprise: 'Enterprise' },
		accountTypeHint: 'Enterprise capability is separate from login role; admin users cannot be enterprise accounts.',
		enterpriseCapability: 'Enable enterprise member capability',
		enterpriseCapabilityHint: 'Disabling immediately rejects all member keys while preserving members, budgets, keys, and usage history.',
      ...
      balanceConsumption: {
        ...
        forecastTitle: 'Balance Forecast',
        forecastDays: 'About {days} days remaining',
        forecastLessThanDay: 'Less than 1 day remaining',
        forecastDepleted: 'Balance depleted',
        forecastNoConsumption: 'No estimated depletion date',
        forecastCalculating: 'Calculating forecast…',
        forecastDate: 'At the {days}-day trend, around {date}',
    ...
    groups: {
      ...
      columnSettings: 'Column Settings',
      sortOrderHint: 'Drag groups and save to set their order in group selectors and model catalogs. Inactive groups retain their position. This does not affect account scheduling.',
      sortOrderValueHint: 'Lower values appear first. Drag groups in Display Order and save to adjust.',
      ...
      openaiMessages: {
        ...
        familyMappingTitle: 'Claude Model Name Handling',
        familyMappingHint: 'Explicitly preserve client model names or deterministically map Claude families to logical models served by this group.',
        passthroughTitle: 'Pass Through',
        passthroughHint: 'Do not rewrite Opus, Sonnet, or Haiku family names.',
        passthroughActiveHint: 'When no exact override matches, the client model name is preserved for account model matching.',
        customTitle: 'Map to Group Models',
        customHint: 'Rewrite Claude families to logical models served by accounts in this group.',
        applyOpenAIPreset: 'Apply OpenAI/Codex Preset',
        optionalModelPlaceholder: 'Leave blank to pass through',
        createCandidateModelsHint: 'Enter models manually while creating the group. Group model suggestions appear after accounts are bound.',
        candidateModelsHint: 'Suggestions come from the left-hand model mappings of schedulable accounts in this group.',
        noCandidateModelsHint: 'This group has no enumerable account model suggestions. You can still enter a logical model name manually.',
        unlistedCandidateWarning: 'This model is not among the enumerable account suggestions for the group. Verify the account model mapping.',
        legacyMappingTitle: 'Using Legacy OpenAI/Codex Defaults',
        legacyMappingHint: 'Existing groups keep their prior GPT mappings to avoid changing live traffic. Choose pass-through or explicit custom mappings to adopt the new behavior.',
        convertToPassthrough: 'Switch to Pass-Through',
        convertToCustom: 'Convert to Explicit Custom',
