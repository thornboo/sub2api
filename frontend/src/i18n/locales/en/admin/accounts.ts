export default {
    accounts: {
      ...
      openai: {
        ...
        responsesMode: 'Legacy Chat / Responses routing preference',
        responsesModeDesc:
          'Only controls OpenAI API Key text forwarding when model multi-endpoint routing is disabled. With strict routing enabled, per-model Upstream Protocol Capabilities are authoritative and this setting cannot override them.',
        ...
        endpointCapabilitiesDesc:
          'Account-level scheduling gates. The text-generation gate does not prove whether a model supports Chat or Responses; strict multi-protocol routing uses Upstream Protocol Capabilities. Embeddings independently controls /v1/embeddings.',
        ...
        responsesStatusAutoSupported: 'Legacy probe: Responses',
        responsesStatusAutoUnsupported: 'Legacy probe: Chat Completions',
        responsesStatusAutoUnknown: 'Legacy probe: not probed',
        responsesStatusForcedResponses: 'Legacy route forced to Responses',
        responsesStatusForcedChatCompletions: 'Legacy route forced to Chat Completions',
      ...
      concreteTestModel: 'Concrete model ID',
      concreteTestModelPlaceholder: 'Enter the full model ID to test',
      concreteTestModelHint: 'This is a wildcard rule. Enter a concrete model ID.',
      concreteTestModelRequired: 'Enter a concrete model ID without *.',
      resolvedTestModel: 'Sent to upstream: {model}',
      resolveTestModelFailed: 'No valid model match. Check the model ID and account configuration.',
      ...
      modelProtocol: {
        ...
        globalRoutingEnabledHint: 'Saved support states participate in customer endpoint visibility and native routing for new requests.',
        globalRoutingDisabled: 'Global multi-endpoint routing is disabled',
        globalRoutingDisabledHint: 'These settings are still saved, but they will not add customer-visible API endpoints or change request routing yet.',
        globalRoutingUnknown: 'Global routing status is temporarily unavailable',
        globalRoutingUnknownHint: 'Account capabilities can still be viewed and saved. Refresh or verify the global switch in system settings before assuming they affect live routing.',
        manageGlobalRouting: 'Manage global switch',
        sync: 'Sync from upstream',
        syncing: 'Syncing...',
        syncSuccess: 'Protocol choices filled from upstream. Save to apply administrator policies.',
        syncNoChanges: 'Sync completed without definite protocol results. Existing choices were preserved.',
        syncWarnings: 'Sync warnings',
        saveSuccess: 'Protocol capability overrides saved',
        addExactModel: 'Add an exact upstream model',
        modelPlaceholder: 'For example MiniMax-M3, for upstreams that cannot declare capabilities',
        addModel: 'Add model',
        invalidModel: 'Model names must be 1–255 characters and cannot contain * or control characters',
        duplicateModel: 'This model is already in the capability list',
        supplierHintTitle: 'Protocol capabilities are configured per account',
        supplierHint: 'Suppliers own cost and balance attribution. Configure capabilities on the corresponding OpenAI API Key account in the account list.',
        goToAccountList: 'Go to account list',
        upstreamModel: 'Upstream model',
        defaultCapability: 'Account default capability',
        exactModel: 'Exact model capability',
        publicModelImpacts: 'Affected channel models',
        moreImpacts: '{count} more channel routes',
        orphanCapability: 'No channel model currently routes through this account to this upstream model',
        anthropicMessages: 'Anthropic Messages',
        openaiChat: 'OpenAI Chat',
        openaiResponses: 'OpenAI Responses',
        effectiveState: 'Effective',
        afterSaveState: 'After saving',
        observedEvidence: 'Upstream observation',
        overridePolicy: 'Admin policy',
        auto: 'Auto',
        forceSupported: 'Force supported',
        forceUnsupported: 'Force unsupported',
        supportedShort: 'Support',
        unsupportedShort: 'No support',
        overrideLabel: '{model} {protocol} administrator override',
        noEvidence: 'No capability evidence',
        saveHint: 'Sync replaces choices with definite results from this sync and preserves unknown choices. Click Save to apply administrator policies.',
        states: {
          supported: 'Supported',
          unsupported: 'Unsupported',
          unknown: 'Unknown'
        ...
        sources: {
          upstreamModelList: 'Declared by upstream model list',
          upstreamDidNotDeclare: 'Upstream did not declare protocol capabilities',
          upstreamEmptyDeclaration: 'Upstream returned an empty protocol capability list',
          upstreamUnknownDeclaration: 'Upstream declared unknown protocol values',
          legacyMigration: 'Migrated legacy probe result',
          adminOverride: 'Administrator override',
          intrinsic: 'Intrinsic account capability'
        }
      },
