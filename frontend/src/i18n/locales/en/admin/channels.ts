export default {
    ...
    channels: {
      ...
      timePricingValidation: {
        tokenOnly: 'Time pricing is only supported for token billing mode',
        invalidTimezone: '"{timezone}" is not a valid IANA timezone',
        defaultLabelRequired: 'Enter a type name for Other times',
        defaultLabelTooLong: 'The Other-times type name supports at most {max} characters',
        defaultMultiplierRange: 'Other-times multiplier "{value}" must be between 0 and 100',
        tooManyRules: 'Time pricing supports at most {max} rules',
        ruleLabelRequired: 'Time rule #{index}: enter a type name',
        ruleLabelTooLong: 'Time rule #{index}: the type name supports at most {max} characters',
        invalidStart: 'Time rule #{index}: start time "{value}" must use HH:MM',
        invalidEnd: 'Time rule #{index}: end time "{value}" must use HH:MM',
        equalRange: 'Time rule #{index}: start and end cannot be the same ({range})',
        multiplierRange: 'Time rule #{index}: multiplier "{value}" must be between 0 and 100',
        overlap: 'Time rules overlap: {first} ({firstRange}) conflicts with {second} ({secondRange})',
      ...
      form: {
        ...
        modelSelfCheck: 'Model self-check',
        ...
        timePricingEnabled: 'Enable time pricing',
        timePricingTimezone: 'Timezone',
        timePricingTimezonePlaceholder: 'Select timezone',
        timePricingTimezoneSearch: 'Search IANA timezones',
        timePricingTimezoneUse: 'Use timezone',
        timePricingOtherTimes: 'Other times',
        timePricingDefaultMultiplier: 'Other-times multiplier',
        timePricingTypeName: 'Type name',
        timePricingDefaultLabelPlaceholder: 'For example: Standard',
        timePricingRuleLabelPlaceholder: 'For example: Peak',
        timePricingStart: 'Start',
        timePricingEnd: 'End',
        timePricingMultiplier: 'Multiplier',
        timePricingAddRule: 'Add window',
        timePricingRemoveRule: 'Remove window',
        timePricingMoveRuleUp: 'Move window up',
        timePricingMoveRuleDown: 'Move window down',
        timePricingCrossMidnight: 'Crosses midnight',
        timePricingFreeWarning: '0x makes this window free',
        timePricingDefaultFreeWarning: '0x makes every time outside explicit windows free',
        timePricingHint: 'Type names are shown to users exactly as entered and are never inferred from multipliers. Times outside explicit windows use the Other-times configuration. Cross-midnight windows are allowed; rules cannot overlap.',
        ...
        intervalBoundsHint: 'Intervals use (min, max]: min is exclusive and max is inclusive. For continuous tiers, set the next min to the previous max. Example: if the first max is 272000, set the second min to 272000; token 272001 will enter the second tier.',
        intervalGapWarning: 'There is a gap between {previousMax} and {currentMin}: tokens {missingStart} through {missingEnd} will not match these intervals and will fall back to base pricing.',
        ...
        dragToSort: 'Drag to change display order',
        sortByName: 'Sort by name',
        sortByMapping: 'Follow mapping order',
        addPricing: 'Add pricing',
        mappingModelsCount: '{count} mapped',
        pricingCoveredCount: '{count} covered',
        pricingMissingCount: '{count} missing',
        pricingExtraCount: '{count} pricing-only',
        showMissingModels: 'Show missing',
        hideMissingModels: 'Hide missing',
        quickPricing: 'Quick pricing',
        quickPricingHint: 'After confirming the mapping, add missing pricing entries from the current mapping',
        quickPricingRunning: 'Pricing...',
        quickPricingSuccess: 'Created pricing entries for {count} model(s)',
        upstreamPricingCoverageUnknown: 'Pricing uses final upstream models, so coverage cannot be inferred reliably from channel mapping alone.',
        missingPricingCoverage: '{platform} still has mapped models missing from the pricing list: {models}',
        mappingPricingStatus: {
          covered: 'Priced',
          missing: 'Missing',
          unknown: 'Unknown',
          pending: 'Incomplete'
    ...
    channelMonitor: {
      ...
      form: {
        ...
        checkModeProbeHint: 'Send a lightweight request to verify endpoint availability.',
        checkModeQuota: 'Quota',
        checkModeQuotaHint: 'Read quota or usage evidence from a linked account when supported.',
        checkModeQuotaProbe: 'Probe + Quota',
        checkModeQuotaProbeHint: 'Read quota evidence and run the availability probe in one check.',
        endpoint: 'Endpoint',
        endpointPlaceholder: 'https://api.example.com',
        linkedAccount: 'Linked account',
        linkedAccountPlaceholder: 'Select a linked account',
        linkedAccountHint: 'Quota checks use this account only for observable quota evidence.',
        linkedAccountMissing: 'The linked account is no longer available. Select another account before saving.',
        linkedAccountEmpty: 'No eligible accounts for this provider',
        openAIQuotaProbeHint: 'OpenAI quota checks require a linked OAuth account with readable quota evidence.',
