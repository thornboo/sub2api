export default {
  ...
  keyUsage: {
    ...
    noModels: 'No models are currently available for this group',
    ...
    trendHint: 'Hover for daily details',
    trendChartLabel: 'Interactive daily spending trend chart',
    ...
    unreadAnnouncements: '{count} unread announcement | {count} unread announcements',
    noUnreadAnnouncements: 'No unread announcements',
    refreshAnnouncements: 'Refresh',
    loadingAnnouncements: 'Loading announcements...',
    noAnnouncements: 'No announcements for this Key',
    announcementsFailed: 'Failed to load announcements',
    announcementReadFailed: 'Failed to mark announcement as read',
    markingAnnouncementRead: 'Marking...',
    unlimited: 'Unlimited',
    never: 'Never',
    status: {
      active: 'Active',
