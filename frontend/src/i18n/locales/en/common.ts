export default {
  ...
  nav: {
    ...
    groups: 'Groups',
    channels: 'Channels',
    availableChannels: 'Model Catalog',
  ...
  feedback: {
    ...
    myTicketsDescription: 'Submit an issue, read replies, and follow its progress.',
    newTicket: 'Submit a ticket',
    titleLabel: 'Title',
    titlePlaceholder: 'For example: Balance not updated after payment',
    titleHint: 'Summarize your issue in one sentence.',
    titleRequired: 'Enter a ticket title.',
    titleTooLong: 'The title cannot exceed {max} characters.',
    filterLabel: 'Ticket status',
    contentLabel: 'Description',
    placeholder: 'Describe what happened, when it occurred, and any relevant details, or share a suggestion.',
    ...
    rateLimited: 'A message was submitted too recently. Try again in {seconds}s.',
    success: 'Ticket submitted',
    replySuccess: 'Reply sent',
    closeSuccess: 'Ticket closed',
    failed: 'Failed to submit ticket. Try again later.',
    replyFailed: 'Failed to send reply. Try again later.',
    closeFailed: 'Failed to close ticket. Try again later.',
    ...
    selectTicket: 'Select a ticket to view its details and replies',
    noReplies: 'No replies yet',
    unreadCount: '{count} unread message | {count} unread messages',
    allTickets: 'All',
    lastActivity: 'Last activity',
    openingMessage: 'Description',
    olderMessages: 'Older',
    newerMessages: 'Newer',
    ...
    closedReadOnly: 'This ticket is closed and no longer accepts replies.',
    closedStale: 'This ticket has been closed. The latest state was loaded.',
    ...
    userReplyStatusLabels: {
      pending: 'Awaiting administrator reply',
      replied: 'Administrator replied'
    },
    authorLabels: {
      user: 'User',
      admin: 'Administrator'
    },
    emptyError: 'Enter a message before submitting.',
    tooLongError: 'The message cannot exceed {max} characters.'
  },
