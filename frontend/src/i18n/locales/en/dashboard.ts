export default {
  ...
  usage: {
    ...
    upstreamExpectedCost: 'Expected upstream cost',
    ...
    upstreamMultiplier: 'Upstream group rate',
    upstreamPriceReference: 'Upstream price reference',
    upstreamReferenceFx: 'Upstream reference FX',
    upstreamCostBindingId: 'Upstream cost binding ID',
