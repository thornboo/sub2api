  ...
  admin: {
    ...
    accounts: {
      ...
      upstreamCost: {
        ...
        comparisonTitle: 'Supplier Cost Comparison',
        comparisonDescription: 'Compare account cost across the current filters. This is a read-only board; maintain cost settings in account editing.',
        readonlyBadge: 'Read-only',
        viewFamily: 'View family',
        configureAction: 'Configure',
        configCoverage: 'Complete rate',
        noBestAccount: 'No complete setup yet',
        status: 'Status',
        completeStatus: 'Complete',
        incompleteStatus: 'Missing fields',
        configuredStatus: 'cost basis recorded',
        needsConfig: 'Needs setup',
        bestChoice: 'Lowest cost',
        missingPrefix: 'Missing',
        noGroups: 'No groups',
        loadFailed: 'Failed to load upstream cost comparison',
        ...
        bestDiscount: 'Lowest effective discount',
