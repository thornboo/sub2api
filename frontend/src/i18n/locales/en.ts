  ...
  admin: {
    ...
    accounts: {
      ...
      upstreamCost: {
        ...
        supplierBindingDescription: 'Choose an existing supplier for this account. Add suppliers and recharge records from the Suppliers tab.',
        supplier: 'Supplier',
        ...
        supplierBindingHint: 'Recharge records are assigned to the selected supplier. This only stores ownership and does not change scheduling.',
        ...
        supplierListDescription: 'Add suppliers and record recharge entries here. Multiple accounts under one supplier share this supplier cost basis.',
