  ...
  admin: {
    ...
    accounts: {
      ...
      views: {
        list: 'Accounts',
        archived: 'Archived',
        upstreamCost: 'Supplier Costs'
      },
      upstreamCost: {
        title: 'Upstream Cost',
        settingsTitle: 'Upstream Cost Settings',
        description: 'Record recharge ratio, reference FX rate, and upstream group multiplier on the account. This only stores the cost basis and does not change scheduling automatically.',
        supplierBindingTitle: 'Upstream Supplier',
        supplierBindingDescription: 'Choose an existing supplier for this account. If it is missing, add it to the list first, then select it from the dropdown.',
        supplier: 'Supplier',
        supplierPlaceholder: 'Select a supplier',
        supplierEmpty: 'No suppliers yet. Use Add on the right.',
        addSupplier: 'Add',
        quickAddSupplier: 'Add to list',
        newSupplierNamePlaceholder: 'For example: Supplier A',
        saveSupplier: 'Save',
        supplierCreateHint: 'After saving, it is added to the dropdown and selected by default. The account binding is applied when you update the account.',
        ...
        supplierBindingHint: 'Recharge records are assigned to the selected supplier. This does not change scheduling.',
        ...
        supplierListTitle: 'Supplier Costs',
        supplierListDescription: 'Record recharge costs by supplier. Multiple accounts under the same supplier share this supplier cost basis.',
        supplierCount: 'Suppliers',
        configuredSuppliers: 'With cost',
        bestSupplier: 'Best supplier discount',
        boundAccounts: 'Bound accounts',
        currentCost: 'Current cost',
        supplierNoPool: 'No balance pool',
        noSuppliers: 'No suppliers yet. Add or bind a supplier from account editing first.',
        status: 'Status',
        ...
        noFamilyOverrides: 'No model-family overrides yet. The default group multiplier is used.',
        familyPlaceholder: 'Model family, e.g. sonnet',
        familyNotePlaceholder: 'Family note',
        defaultFamily: 'Default',
        rechargeRatio: 'Recharge / FX',
