export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      probeModelsSummary: 'Fetch complete: {added} added, {existing} already present, {missing} fetch issues',
      probeModelsSummaryWithConflicts: 'Fetch complete: {added} added, {existing} already present, {missing} fetch issues, {conflicts} source conflicts',
      probeModelNew: 'New',
      probeModelMissing: 'Fetch issue',
      ...
      keyPool: {
        title: 'Upstream API Key Pool',
        hint: 'Keys under the same upstream account are tried by priority and recent use; failures cool down only the selected key + upstream model.',
        add: 'Add key',
        empty: 'Add at least one upstream API key.',
        required: 'Add at least one key in the upstream API key pool',
        rowRequired: 'Each upstream API key needs both a note and a key value',
        modelsRequired: 'Each upstream API key needs its own model whitelist or mapping',
        noteLabel: 'Note',
        apiKeyLabel: 'API Key',
        priorityLabel: 'Priority',
        priorityHint: 'Lower value means higher priority; same-priority keys rotate by recent use.',
        statusLabel: 'Status',
        namePlaceholder: 'e.g. packycode group A',
        apiKeyPlaceholder: 'Enter upstream API key',
        apiKeyPlaceholderEdit: 'Leave empty to keep existing key',
        statusActive: 'Active',
        ...
        modelRestrictionTitle: 'Model limits for this key',
        modelRestrictionHint: 'Each key defines its own model capability; scheduling only sends requests to keys that match the current model.',
        whitelistPlaceholder: 'One upstream model per line, e.g.\nclaude-haiku-4.5'
      },
      poolMode: 'Pool Mode',
