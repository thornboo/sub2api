export default {
  ...
  keys: {
    ...
    batchActions: {
      ...
      updateHint:
        'Apply the same configuration to {count} selected key(s). Only checked fields are changed; unchecked fields stay unchanged.',
      updateFilteredHint:
        'Apply the same configuration to {count} key(s) matching the current filters. Only checked fields are changed; unchecked fields stay unchanged.',
      ...
      deleteFilteredConfirm:
        'Delete {count} API key(s) matching the current filters? These keys will stop working after deletion.',
