  ...
  admin: {
    ...
    accounts: {
      ...
      upstreamCost: {
        ...
        supplierBindingDescription: '给这个账号选择已有供应商；供应商的新增和充值记录请在「供应商」标签页处理。',
        supplier: '供应商',
        ...
        supplierBindingHint: '充值记录会归到所选供应商；这里只保存归属，不会改变调度。',
        supplierLoadFailed: '加载上游供应商失败',
        supplierPool: '主余额池',
        supplierRechargeScope: '供应商充值',
        supplierListTitle: '供应商',
        supplierListDescription: '在这里新增供应商并录入充值记录；同一供应商下的多个账号会共享这套充值成本口径。',
        supplierCount: '供应商',
