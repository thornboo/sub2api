  ...
  admin: {
    ...
    accounts: {
      ...
      upstreamCost: {
        ...
        comparisonTitle: '供应商成本对比',
        comparisonDescription: '按当前筛选条件横向对比账号成本。这里是只读看板，成本参数请在账号编辑里维护。',
        readonlyBadge: '只读对比',
        viewFamily: '查看系列',
        configureAction: '去配置',
        configCoverage: '完整率',
        noBestAccount: '暂无完整配置',
        status: '状态',
        completeStatus: '已配完整',
        incompleteStatus: '缺字段',
        configuredStatus: '已录入口径',
        needsConfig: '待配置',
        bestChoice: '最低成本',
        missingPrefix: '缺',
        noGroups: '未分组',
        loadFailed: '加载上游成本对比失败',
