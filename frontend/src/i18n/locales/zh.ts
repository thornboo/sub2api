  ...
  admin: {
    ...
    accounts: {
      ...
      upstreamCost: {
        ...
        description: '在账号里记录上游充值比例、参考汇率和分组倍率，用来估算供应商综合折扣；这里只保存成本口径，不会自动改调度。',
        supplierBindingTitle: '上游供应商',
        supplierBindingDescription: '给这个账号选择已有供应商；没有时先新增到列表，再从下拉框选择。',
        supplier: '供应商',
        supplierPlaceholder: '请选择供应商',
        supplierEmpty: '暂无可选供应商，请点击右侧新增',
        addSupplier: '新增',
        quickAddSupplier: '新增到列表',
        newSupplierNamePlaceholder: '例如：供应商 A',
        saveSupplier: '保存',
        supplierCreateHint: '保存后会加入下拉列表并默认选中；账号归属以底部更新为准。',
        ...
        supplierBindingHint: '充值记录会归到所选供应商；这里不会改变调度。',
        supplierLoadFailed: '加载上游供应商失败',
        supplierPool: '主余额池',
        supplierRechargeScope: '供应商充值',
        supplierListTitle: '供应商成本',
        supplierListDescription: '按供应商记录充值成本；同一供应商下的多个账号共享这里的充值成本口径。',
        supplierCount: '供应商',
        configuredSuppliers: '已有成本',
        bestSupplier: '最低供应商折扣',
        boundAccounts: '绑定账号',
        currentCost: '当前成本',
        supplierNoPool: '未建余额池',
        noSuppliers: '暂无供应商，请先在账号编辑里新增或绑定供应商。',
        status: '状态',
        completeStatus: '已配完整',
        archivedStatus: '已归档',
        needsConfig: '待配置',
        ...
        addFamily: '添加系列',
        noFamilyOverrides: '暂无模型系列覆盖，默认使用上面的分组倍率。',
