      ...
      <div class="collapsible-inner">
        ...
        <div v-if="entry.billing_mode === 'token'">
          ...
          <div class="pricing-default-grid mt-1 grid gap-2">
            ...
            <div>
              <label class="text-xs text-stone-400">{{ t('admin.channels.form.cacheWrite1hPrice') }}</label>
          ...
          <div v-if="enableTierMultipliers" class="mt-3 grid max-w-md grid-cols-2 gap-2">
            <div>
              <label class="text-xs text-stone-400">{{ t('admin.channels.form.fastMultiplier') }}</label>
            ...
            <div>
              <label class="text-xs text-stone-400">{{ t('admin.channels.form.flexMultiplier') }}</label>
        ...
        <div v-else-if="entry.billing_mode === 'image' || entry.billing_mode === 'video'">
          ...
          <div class="mt-3 flex items-center justify-between">
            ...
            <button type="button" @click="addMediaTier" class="text-xs text-emerald-600 transition-colors hover:text-emerald-700 dark:text-emerald-400 dark:hover:text-emerald-300">
              + {{ t('admin.channels.form.addTier') }}
            </button>
          </div>
          <div v-if="entry.intervals && entry.intervals.length > 0" class="mt-2 space-y-2">
