    ...
    <Teleport to="body">
      ...
      <div
        ...
        :class="[
          ...
          placement === 'top' ? 'before:absolute before:inset-x-0 before:top-full before:h-3' : '',
          'selection:bg-primary-200 selection:text-gray-900 dark:selection:bg-primary-200 dark:selection:text-gray-900',
          props.widthClass,
        ]"
