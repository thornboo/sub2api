    ...
    <template v-if="isAdmin">
      ...
      <transition name="dropdown">
        <div
          v-if="dropdownOpen"
          ref="dropdownRef"
          class="absolute left-0 z-50 mt-2 overflow-hidden whitespace-normal rounded-xl border border-stone-200/80 bg-white/95 shadow-xl shadow-stone-950/10 ring-1 ring-black/5 backdrop-blur-xl transition-all duration-200 dark:border-white/10 dark:bg-neutral-950/95 dark:shadow-black/35 dark:ring-white/10"
...
const GITHUB_REPO = 'thornboo/sub2api'
// Fork image tags carry no "v" prefix, for example thornboo/sub2api:1.5.1.
const DOCKER_IMAGE = 'thornboo/sub2api'
