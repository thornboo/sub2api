<template>
  <div v-if="rows.length > 0" class="space-y-2">
    ...
    >
      ...
      <button
        type="button"
        class="rounded-lg p-2 text-rose-500 transition-colors hover:bg-rose-50 hover:text-rose-600 dark:text-rose-400 dark:hover:bg-rose-500/10 dark:hover:text-rose-300"
