<template>
  <button
    type="button"
    class="rounded-lg bg-emerald-50 px-3 py-1 text-xs text-emerald-700 transition-colors hover:bg-emerald-100 dark:bg-emerald-500/10 dark:text-emerald-300 dark:hover:bg-emerald-500/20"
  ...
  <button
    type="button"
    class="rounded-lg bg-emerald-50 px-3 py-1 text-xs text-emerald-700 transition-colors hover:bg-emerald-100 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-emerald-500/10 dark:text-emerald-300 dark:hover:bg-emerald-500/20"
  ...
  <div v-if="showImportPanel" ref="importPanelRef" class="w-full space-y-2">
    ...
    <div class="flex gap-2">
      <button
        type="button"
        class="rounded-lg bg-emerald-500 px-3 py-1 text-xs font-medium text-neutral-950 transition-colors hover:bg-emerald-400"
        @click="applyImport"
      >
      ...
      <button
        type="button"
        class="rounded-lg bg-stone-100 px-3 py-1 text-xs text-stone-600 transition-colors hover:bg-stone-200 dark:bg-white/10 dark:text-stone-300 dark:hover:bg-white/15"
