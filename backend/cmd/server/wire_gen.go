...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	availableChannelHandler := handler.NewAvailableChannelHandler(channelService, apiKeyService, settingService, modelDeliveryService)
	modelPlazaHandler := handler.NewModelPlazaHandler(channelService, settingService, modelDeliveryService)
