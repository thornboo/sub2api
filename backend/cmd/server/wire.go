...
func provideCleanup(
	...
	enterpriseMemberImportWorker *service.EnterpriseMemberImportWorker,
	...
	modelSelfCheckRunner *service.ModelSelfCheckRunner,
	channelMonitorV2Aggregator *service.ChannelMonitorV2Aggregator,
	quotaFlusher *service.UserPlatformQuotaUsageFlusher,
	upstreamBillingProbe *service.UpstreamBillingProbeService,
	upstreamSupplierBalancePoller *service.UpstreamSupplierBalancePoller,
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"RoutingEligibilityRuntime", func() error {
				if routingEligibility != nil {
					routingEligibility.Stop()
				}
				return nil
			}},
			...
			{"EnterpriseMemberImportWorker", func() error {
				if enterpriseMemberImportWorker != nil {
					enterpriseMemberImportWorker.Stop()
				}
				return nil
			}},
			...
			{"ModelSelfCheckRunner", func() error {
				if modelSelfCheckRunner != nil {
					modelSelfCheckRunner.Stop()
				}
				return nil
			}},
			...
			{"UpstreamSupplierBalancePoller", func() error {
				if upstreamSupplierBalancePoller != nil {
					upstreamSupplierBalancePoller.Stop()
				}
				return nil
			}},
