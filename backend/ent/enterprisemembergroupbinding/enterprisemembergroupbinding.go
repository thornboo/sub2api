...
const (
	// Label holds the string label denoting the enterprisemembergroupbinding type in the database.
	Label = "enterprise_member_group_binding"
	...
	EdgeGroup = "group"
	// EnterpriseMemberFieldID holds the string denoting the ID field of the EnterpriseMember.
	EnterpriseMemberFieldID = "id"
	// GroupFieldID holds the string denoting the ID field of the Group.
	GroupFieldID = "id"
	// Table holds the table name of the enterprisemembergroupbinding in the database.
	Table = "enterprise_member_group_bindings"
	// MemberTable is the table that holds the member relation/edge.
	MemberTable = "enterprise_member_group_bindings"
	...
	GroupTable = "enterprise_member_group_bindings"
...
// Columns holds all SQL columns for enterprisemembergroupbinding fields.
var Columns = []string{
	FieldMemberID,
	FieldGroupID,
	FieldSortOrder,
...
// OrderOption defines the ordering options for the EnterpriseMemberGroupBinding queries.
...
func newMemberStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		...
		sqlgraph.To(MemberInverseTable, EnterpriseMemberFieldID),
