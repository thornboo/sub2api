...
func (BatchImageJob) Fields() []ent.Field {
	return []ent.Field{
		...
		field.String("member_code_snapshot").Optional().Nillable().MaxLen(128),
		field.String("member_name_snapshot").Optional().Nillable().MaxLen(255),
		...
		field.String("member_budget_request_id").Optional().Nillable().MaxLen(128),
