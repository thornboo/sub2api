...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.CompositeModelRoute, c.EnterpriseMember, c.EnterpriseMemberBudgetEntry,
		c.EnterpriseMemberBudgetPeriod, c.EnterpriseMemberBudgetReservation,
		c.EnterpriseMemberGroupBinding, c.ErrorPassthroughRule, c.Group,
...
type (
	hooks struct {
		...
		ChannelMonitorRequestTemplate, CompositeModelRoute, EnterpriseMember,
		EnterpriseMemberBudgetEntry, EnterpriseMemberBudgetPeriod,
		EnterpriseMemberBudgetReservation, EnterpriseMemberGroupBinding,
