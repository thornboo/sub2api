...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	normalizedOpenAIFastPolicy, err := h.settingService.UpdateSettingsWithAuthSourceDefaultsAndOpenAIFastPolicyOmitting(
		c.Request.Context(),
		settings,
		authSourceDefaults,
	...
	h.auditSettingsUpdate(c, previousSettings, settings, previousAuthSourceDefaults, authSourceDefaults, auditReq, extraAuditChanges...)
