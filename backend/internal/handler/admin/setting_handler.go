...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		EnterpriseMemberModelAdmissionMode:                     settings.EnterpriseMemberModelAdmissionMode,
		EnterpriseMemberModelAdmissionSource:                   settings.EnterpriseMemberModelAdmissionSource,
		EnterpriseMemberModelAdmissionEnforceReady:             settings.EnterpriseMemberModelAdmissionEnforceReady,
		EnterpriseMemberModelAdmissionEnforceReason:            settings.EnterpriseMemberModelAdmissionEnforceReason,
		EnterpriseMemberModelAdmissionReadiness:                settings.EnterpriseMemberModelAdmissionReadiness,
