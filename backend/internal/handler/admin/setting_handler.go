...
// GetModelRateLimitSettings 获取模型级限流策略配置
// GET /api/v1/admin/settings/model-rate-limit
...
// UpdateModelRateLimitSettings 更新模型级限流策略配置
// PUT /api/v1/admin/settings/model-rate-limit
