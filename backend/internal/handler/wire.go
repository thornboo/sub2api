...
func ProvideAdminHandlers(
	...
	modelSelfCheckHandler *admin.ModelSelfCheckHandler,
	...
	return &AdminHandlers{
		...
		ModelSelfCheck:         modelSelfCheckHandler,
...
func ProvideOpenAIGatewayHandler(
	...
	h := NewOpenAIGatewayHandler(gatewayService, concurrencyService, billingCacheService, apiKeyService,
		...
		memberBudgetService, grokMediaTaskRepository, cfg)
	h.securityAuditCoordinator = coordinator
...
func ProvideHandlers(
	...
	enterpriseMemberHandler *EnterpriseMemberHandler,
	...
	_ *service.EnterpriseMemberBudgetRecoveryService,
	_ *service.EnterpriseMemberImportCleanupService,
) *Handlers {
	return &Handlers{
		Auth:             authHandler,
		User:             userHandler,
...
var ProviderSet = wire.NewSet(
	...
	admin.NewModelSelfCheckHandler,
