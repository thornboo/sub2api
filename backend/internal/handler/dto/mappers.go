...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		GroupID:                   l.GroupID,
		MemberID:                  l.MemberID,
		MemberCode:                l.MemberCodeSnapshot,
		MemberName:                l.MemberNameSnapshot,
...
func UsageLogFromServiceAdmin(l *service.UsageLog) *AdminUsageLog {
	...
	return &AdminUsageLog{
		...
		UpstreamCostBindingID:          l.UpstreamCostBindingID,
		UpstreamGroupMultiplier:        l.UpstreamGroupMultiplier,
		UpstreamPriceReferenceCurrency: l.UpstreamPriceReferenceCurrency,
		UpstreamReferenceFXRate:        l.UpstreamReferenceFXRate,
		UpstreamExpectedCost:           l.UpstreamExpectedCost,
...
func UsageScheduleMetaFromService(meta *service.UsageScheduleMeta) *UsageScheduleMeta {
	...
	return &UsageScheduleMeta{
		...
		PricingAt:             meta.PricingAt,
		TimePricingMultiplier: meta.TimePricingMultiplier,
		TimePricingTimezone:   meta.TimePricingTimezone,
		TimePricingLabel:      meta.TimePricingLabel,
		TimePricingRule:       meta.TimePricingRule,
	}
}
