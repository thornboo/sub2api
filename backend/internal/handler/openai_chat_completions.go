...
func (h *OpenAIGatewayHandler) ChatCompletions(c *gin.Context) {
	...
	for {
		...
		h.recordCyberPolicyIfMarked(c, apiKey, account, subscription, reqModel, err != nil, cyberBlockBodyChat, clientRequestedUsageFields(c, channelMapping, reqModel, ""), service.HashUsageRequestPayload(body), c.Request.Context())
		...
		if result != nil {
			h.gatewayService.ReportOpenAIAccountScheduleResult(account, openAIScheduleResultModel(account, deliveryDecision, deliveryRoutingModel, result), true, result.FirstTokenMs)
		} else {
			h.gatewayService.ReportOpenAIAccountScheduleResult(account, openAIScheduleResultModel(account, deliveryDecision, deliveryRoutingModel, result), true, nil)
		}
