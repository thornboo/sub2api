...
func ProvideRouter(
	...
	return SetupRouter(r, handlers, jwtAuth, adminAuth, apiKeyAuth, auditLog, stepUpAuth, apiKeyService, memberBudgetService, subscriptionService, opsService, settingService, cfg, redisClient)
}
