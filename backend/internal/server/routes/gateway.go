...
func RegisterGatewayRoutes(
	...
	gateway.Use(requireGroupAnthropic)
	{
		...
		gateway.POST("/images/generations/async", orchestrateMemberGroups(h.AsyncImage.Submit))
		gateway.POST("/images/edits/async", orchestrateMemberGroups(h.AsyncImage.Submit))
	...
	r.GET("/models", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), resolveMemberGroupAnthropic, enforceMemberBudgetAnthropic, requireGroupAnthropic, memberModelsHandler)
	...
	r.POST("/images/generations/async", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), resolveMemberGroupAnthropic, enforceMemberBudgetAnthropic, requireGroupAnthropic, orchestrateMemberGroups(h.AsyncImage.Submit))
	r.POST("/images/edits/async", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), resolveMemberGroupAnthropic, enforceMemberBudgetAnthropic, requireGroupAnthropic, orchestrateMemberGroups(h.AsyncImage.Submit))
	r.GET("/images/tasks/:task_id", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), resolveMemberGroupAnthropic, enforceMemberBudgetAnthropic, requireGroupAnthropic, h.AsyncImage.Get)
