...
func RegisterUserRoutes(
	...
	authenticated.Use(gin.HandlerFunc(auditLog))
	{
		...
		user := authenticated.Group("/user")
		{
			...
			user.GET("/api-keys/:id/usage/trend", panelRateLimiter.Heavy(), h.Usage.GetMyAPIKeyUsageTrend)
			user.GET("/api-keys/:id/usage/models", panelRateLimiter.Heavy(), h.Usage.GetMyAPIKeyModelStats)
		...
		enterpriseMembers := authenticated.Group("/enterprise/members")
		{
			...
			enterpriseMembers.PATCH("/batch", h.EnterpriseMember.BatchUpdate)
			enterpriseMembers.PUT("/batch/groups", h.EnterpriseMember.BatchReplaceGroups)
			enterpriseMembers.POST("/batch/usage-adjustments", h.EnterpriseMember.BatchAdjustUsage)
