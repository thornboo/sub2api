...
func SetupRouter(
	...
	if web.HasEmbeddedFrontend() {
		if frontendServer, err := web.NewFrontendServer(settingService); err != nil { //nolint:staticcheck // SA4023: embed build's NewFrontendServer always returns nil err; guard kept for cross-build correctness.
	...
	// 注册路由
	registerRoutes(r, handlers, jwtAuth, adminAuth, apiKeyAuth, auditLog, stepUpAuth, apiKeyService, memberBudgetService, subscriptionService, opsService, settingService, compositeResolver, cfg, redisClient)
...
func registerRoutes(
	...
	routes.RegisterGatewayRoutes(r, h, apiKeyAuth, apiKeyService, memberBudgetService, subscriptionService, opsService, settingService, compositeResolver, cfg)
