...
type SystemSettings struct {
	...
	NativeModelProtocolRoutingEnabled                    bool   // 是否允许确认的模型协议能力参与原生路由
	NativeModelProtocolRoutingSource                     string // settings/config，供管理员识别当前生效来源
	EnterpriseMemberModelAdmissionMode                   string // 企业成员多分组模型准入模式
	EnterpriseMemberModelAdmissionSource                 string // settings/config/settings_invalid/config_invalid/error_fallback/enforce_blocked
	EnterpriseMemberModelAdmissionEnforceReady           bool   // 阶段 3 服务端权威 readiness
	EnterpriseMemberModelAdmissionEnforceReason          string // 未就绪时的稳定原因码
	EnterpriseMemberModelAdmissionReadiness              EnterpriseMemberModelAdmissionEnforceReadiness
	EnterpriseMemberModelAdmissionRollout                EnterpriseMemberModelAdmissionRolloutState
	EnterpriseMemberModelAdmissionLegacy                 EnterpriseMemberModelAdmissionLegacyRetirementStatus
	EnterpriseMemberModelAdmissionLegacyRetirementTarget string
