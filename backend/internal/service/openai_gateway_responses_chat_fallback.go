...
func (s *OpenAIGatewayService) forwardResponsesViaRawChatCompletions(
	...
	functionTools := apicompat.FunctionToolNames(registry.Tools())
	...
	chatReq, err := apicompat.ResponsesToChatCompletionsRequestWithRegistryAndOptions(&responsesReq, registry, capabilities, &apicompat.ResponsesToChatOptions{
...
func (s *OpenAIGatewayService) streamChatCompletionsAsResponses(
	...
	scan := s.scanCCStream(c, resp, "openai responses chat fallback", requestID, startTime, func(chunk *apicompat.ChatCompletionsChunk) error {
